...
SELECT id, nome, email, senha, data_nascimento, celular, curso, perfil FROM usuarios;
...
-- ===========================================================
-- UNINDO VALORES DAS TABELAS usuarios, livros e avaliacoes
-- ===========================================================
...
-- PARA VER ITENS ESPECÍFICOS
SELECT avaliacoes.nota, usuarios.nome, livros.titulo FROM avaliacoes
